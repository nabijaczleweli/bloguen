...
#[test]
fn ok() {
    let root = temp_dir().join("bloguen-test").join("ops-post-generate-alt_no_center_no_asset_override-ok");
...
#[test]
fn not_found() {
    let root = temp_dir().join("bloguen-test").join("ops-post-generate-alt_no_center_no_asset_override-not_found");
    let _ = fs::remove_dir_all(&root);
    for d in &["1. 2018-01-08 16-52 My first venture into crocheting, and what I've learned"] {
...
#[test]
fn non_utf8() {
    let root = temp_dir().join("bloguen-test").join("ops-post-generate-alt_no_center_no_asset_override-not_utf8");
    let _ = fs::remove_dir_all(&root);
    for d in &["1. 2018-01-08 16-52 My first venture into crocheting, and what I've learned"] {
        let fp = root.join("posts").join(d);
        fs::create_dir_all(&fp).unwrap();
...
#[test]
fn posts_directory() {
    let root = temp_dir().join("bloguen-test").join("ops-post-generate-alt_no_center_no_asset_override-posts_directory");
    let _ = fs::remove_dir_all(&root);
    for d in &["1. 2018-01-08 16-52 My first venture into crocheting, and what I've learned"] {
        let fp = root.join("posts").join(d);
        fs::create_dir_all(&fp).unwrap();
...
#[test]
fn post_create() {
    let root = temp_dir().join("bloguen-test").join("ops-post-generate-alt_no_center_no_asset_override-post_create");
    let _ = fs::remove_dir_all(&root);
    for d in &["1. 2018-01-08 16-52 My first venture into crocheting, and what I've learned"] {
        let fp = root.join("posts").join(d);
        fs::create_dir_all(&fp).unwrap();
